...
export const works = [
  {
    ...
    tags: ['ELK', '系統觀測', '資料分析'],
    image: '/works/system-observation.png',
    imageAlt: '抓出讓系統卡頓的元兇簡報封面縮圖',
    pdf: '/works/system-observation.pdf',
    frames: [
      '/works/frames/system-01.png',
      '/works/frames/system-02.png',
      '/works/frames/system-03.png',
      '/works/frames/system-04.png',
    ],
    note: '共同製作作品',
  },
  {
    ...
    tags: ['在地文化', '報告整理', '簡報設計'],
    image: '/works/penghu-museum-report.png',
    imageAlt: '澎湖博物館之旅報導簡報封面縮圖',
    pdf: '/works/penghu-museum-report.pdf',
    frames: [
      '/works/frames/museum-01.png',
      '/works/frames/museum-02.png',
      '/works/frames/museum-03.png',
      '/works/frames/museum-04.png',
    ],
    note: '課堂參訪報告',
  },
  {
    ...
    tags: ['資訊整理', '安全教育', '法規閱讀'],
    image: '/works/drone-safety-guide.png',
    imageAlt: '無人機與澎湖飛行安全指南簡報封面縮圖',
    pdf: '/works/drone-safety-guide.pdf',
    frames: [
      '/works/frames/drone-01.png',
      '/works/frames/drone-02.png',
      '/works/frames/drone-03.png',
      '/works/frames/drone-04.png',
    ],
    note: '含引用素材，來源見原簡報',
  },
]
